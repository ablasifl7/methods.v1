...
public class Panell {
    ...
    final private static String CAPSALERA = "ATENCI”";
    ...
    public static int inputInt(Object message, String title) {
        try {
            ...
            panellAcceptar("El valor introduit no es num√®ric.\n Es considerar√† que s'ha introduit '0'");
